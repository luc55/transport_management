                    ...
                    <div className="auto-container">
                        <div className="inner-container">
                            ...
                            <div className="top-right">
                                <div className="date">Language</div>
                                <ul className="social-icon-four">
                                    <li><a href="#"><span className="fab fa-facebook-square"></span></a></li>
                                    <li><a href="#"><span className="fab fa-twitter"></span></a></li>
                                    <li><a href="#"><span className="fab fa-youtube"></span></a></li>
                                    <li><a href="#"><span className="fab fa-brands fa-linkedin"></span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="outer-box">
                                ...
                                <div className="info-box-one">
                                    <div className="inner">
                                        ...
                                        <div className="info">
                                            <a href="tel:+12 3656 3215">+12 3656 3215</a>
                                ...
                                <a href="page-contact" className="theme-btn btn-style-two"><i className="icon fa fas fa-plus"></i><span className="btn-title">Request A Quote</span></a>
                            ...
                            <div className="main-box">
                                ...
                                <div className="nav-outer">
                                    ...
                                    <div className="outer-box">
                                        ...
                                        <a href="page-contact" className="theme-btn btn-style-two"><i className="icon fa fas fa-plus"></i><span className="btn-title">Track Your Order</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
