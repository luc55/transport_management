...
const Product = () => {
  return (
    <>
    <section className="featured-products pt-120">
      <span className="bg-shape"></span>
      <div className="auto-container">
        <div className="row">
          {/* Product Block */}
          <div className="product-block mb-50 col-lg-3 col-md-6 col-sm-12">
          ...
          {/* Product Block */}
          <div className="product-block mb-md-50 col-lg-3 col-md-6 col-sm-12">
            <div className="inner-box">
              <div className="image-box">
                <div className="image"><Link href="shop-product-details"><img src="/images/resource/products/4.jpg" alt="" /></Link></div>
                <div className="icon-box">
          ...
          {/* Product Block */}
          <div className="product-block mb-sm-50 col-lg-3 col-md-6 col-sm-12">
            <div className="inner-box">
              <div className="image-box">
                <div className="image"><Link href="shop-product-details"><img src="/images/resource/products/2.jpg" alt="" /></Link></div>
                <div className="icon-box">
