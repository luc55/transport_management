          ...
          <div className="col-xl-8 col-lg-7">
            <div className="blog-details__left">
              ...
              <div className="blog-details__content">
                ...
                <h3 className="blog-details__title">Transport & Logistics Services</h3>
              ...
              <div className="comment-one">
                ...
                <div className="comment-one__single">
                  <div className="comment-one__image"> <img src="images/resource/testi-2.jpg" alt=""/> </div>
                  <div className="comment-one__content">
                    <h3>Sarah Albert</h3>
                    <p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla.
                      Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla,
            ...
            <div className="sidebar">
                ...
                <ul className="sidebar__post-list list-unstyled">
                  <li>
                    ...
                    <div className="sidebar__post-content">
                      <h3> <span className="sidebar__post-content-meta"><i className="fas fa-user-circle"></i>Admin</span> <Link href="news-details">Top crypto exchange influencers</Link>
                      </h3>
                    </div>
                  </li>
                  <li>
              ...
              <div className="sidebar__single sidebar__category">
                ...
                <ul className="sidebar__category-list list-unstyled">
                  ...
                  <li className="active"><Link href="news-details">Transport<span className="icon-right-arrow"></span></Link></li>
                  ...
                  <li><Link href="news-details">Warehouses<span className="icon-right-arrow"></span></Link> </li>
                </ul>
              </div>
              <div className="sidebar__single sidebar__tags">
                <h3 className="sidebar__title">Tags</h3>
                <div className="sidebar__tags-list"> <Link href="#">Transport</Link> <Link href="#">Cargo</Link> <Link href="#">Business</Link> <Link href="#">Delivery</Link> <Link href="#">Warehouses</Link> <Link href="#">Logistic</Link> </div>
              </div>
